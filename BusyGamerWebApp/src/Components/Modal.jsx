...
export default function Modal({ open, children, onClose }) {
	...
	return ReactDom.createPortal(
		<>
			<div className="fixed top-0 right-0 left-0 bottom-0 w-screen h-screen bg-opacity-50 backdrop-blur-sm bg-black z-10 flex justify-center pt-32 animate-fade-in">
